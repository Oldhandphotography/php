...
<body>
  ...
  <div class="container">
    ...
    <form class="pt-8 p-4" action="/crud.php" method="post">
      <div class="mb-3">
      ...
      <div class="form-floating">
        <textarea class="form-control" placeholder="Leave a comment here" id="description" name="desc" style="height: 100px"></textarea>
